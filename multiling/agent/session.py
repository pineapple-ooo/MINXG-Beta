...
class AgentMessage:
    ...
    receiver: str         # 接收者 agent_id（""=广播）
    content: str          # 消息内容
    msg_type: str = "text"  # text/tool_call/tool_result/query/response
    tool_name: str = ""   # 如果 msg_type 是 tool_call
...
class MultiAgentSession:
    ...
    def __init__(self, session_id: str = None, max_rounds: int = 100):
        ...
        self._status = "initialized"  # initialized/running/paused/completed/failed
    ...
    def _resolve_by_voting(self, proposals: List[Dict]) -> Optional[Dict]:
        ...
        return {
            ...
            "selected": proposals[0],  # 简化：返回第一个提案
        }
