...
class Capability:
    """能力声明"""
    name: str                       # 能力名称（如 "python_programming"）
    category: str = "general"       # 分类：general/tool/knowledge/language
    level: int = 1                  # 熟练度 1-10
...
class CapabilityRegistry:
    ...
    def __init__(self):
        ...
        self._category_index: Dict[str, List[str]] = {}  # category -> [capability_names]
        self._tag_index: Dict[str, List[str]] = {}        # tag -> [capability_names]
