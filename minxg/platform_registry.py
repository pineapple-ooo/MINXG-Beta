...
# Format: tool_name -> {"platforms": [...], "category": "...", "requires_root": bool}
# If a platform is not listed, the tool is unavailable on that platform.
...
TOOL_PLATFORM_MATRIX: Dict[str, Dict] = {
    ...
    # ── ROOT tools (Android only, requires root) ──
...
# ═══════════════════════════════════════════════════════════════════════════════
# Tool categories for AI context compression
# ═══════════════════════════════════════════════════════════════════════════════
