...
class TestModelCompare:
    ...
    def test_comparison_result(self):
        ...
        comparator = ModelComparator()
        results = [
            {"model": "model-a", "response": "Response A", "latency": 1.0, "cost": 0.01},
            {"model": "model-b", "response": "Response B", "latency": 0.5, "cost": 0.02},
        ]
        summary = comparator.compare(results, ["model-a", "model-b"], {})
