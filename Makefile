...
test: c-build
	...
	@echo "  Library: $(shell ls -lh $(C_TARGET) 2>/dev/null || echo 'NOT BUILT')"
	@echo ""
	@echo "=== Python bridge test ==="
	cd $(ROOT) && python3 scripts/test_native.py 2>&1 || echo "  [SKIP] Python test script not found"
